...
void krnl_attn(float* x,
                int512_t* w_tiling_q_qwieght, int512_t*w_tiling_q_zeros, float* w_tiling_q_scale,
                int512_t* w_tiling_k_qwieght, int512_t*w_tiling_k_zeros, float* w_tiling_k_scale,
                int512_t* w_tiling_v_qwieght, int512_t*w_tiling_v_zeros, float* w_tiling_v_scale,
...
#pragma HLS INTERFACE m_axi port = w_tiling_q_qwieght offset = slave bundle = gmem1 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128
#pragma HLS INTERFACE m_axi port = w_tiling_q_zeros offset = slave bundle = gmem2 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128/128
#pragma HLS INTERFACE m_axi port = w_tiling_q_scale offset = slave bundle = gmem3 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128
#pragma HLS INTERFACE m_axi port = w_tiling_k_qwieght offset = slave bundle = gmem4 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128
#pragma HLS INTERFACE m_axi port = w_tiling_k_zeros offset = slave bundle = gmem5 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128/128
#pragma HLS INTERFACE m_axi port = w_tiling_k_scale offset = slave bundle = gmem6 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128
#pragma HLS INTERFACE m_axi port = w_tiling_v_qwieght offset = slave bundle = gmem7 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128
#pragma HLS INTERFACE m_axi port = w_tiling_v_zeros offset = slave bundle = gmem8 depth = DATA_SIZE_ATTN_WEIGHT_TILED/128/128
...
// #pragma HLS DATAFLOW
    ...
    reshape_weight(w_tiling_q_qwieght, w_tiling_q_zeros, w_tiling_q_scale, w_tiling_q_buf, DATA_SIZE_PROJ_WEIGHT);
    reshape_weight(w_tiling_k_qwieght, w_tiling_k_zeros, w_tiling_k_scale, w_tiling_k_buf, DATA_SIZE_PROJ_WEIGHT);
    reshape_weight(w_tiling_v_qwieght, w_tiling_v_zeros, w_tiling_v_scale, w_tiling_v_buf, DATA_SIZE_PROJ_WEIGHT);
